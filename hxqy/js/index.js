    ...
    var weReadIndexIE8 = function() {
        var e = {
            ...
            setStyle: function() {
                ...
                $('#page_download').prepend('<img id="page_download_hand_ie" src="images/page1-1.png">');
                $('#logo').remove();
        ...
        var ay = {
            ...
            setStyle: function() {
                if (GLOBAL.DEVICE_TYPE === 0) {
                    ...
                    ah.href = 'https://itunes.apple.com/cn/app/id1192172723?mt=8';
                } else if (GLOBAL.DEVICE_TYPE === 2) {
                    ax.style.display = 'none';
                    ag.style.display = 'block';
                    ah.href = 'http://wcy.fgtrj.com/nankexiaoyou.apk';
                }
                if (GLOBAL.DEVICE_TYPE) {
                    M.style.backgroundImage = 'url("images/page5-4.png")';
                }
            ...
            switchStyle: function(aC) {
                switch (aC) {
                    case 'pc-vertical':
                        ...
                        break;
                    case 'pc-horizontal':
                        M.style.backgroundImage = 'url("images/page5-3.png")';
                        aA([al, ak, aj, d, e]);
                        if (ao !== 0) {
