...
function sendEmail(nickname, email, content, articleId, fid, femail, fnickname){
    var toEmail = !!femail ? femail : 'zongyu.liu@foxmail.com';
    var title = !!fnickname ? '尊敬的' + fnickname + '您好,您在Cinoliu Blog中的评论有回复啦!赶紧过来看看吧!' : '您有新的评论!';
    var content = '<p>' + (!!fnickname ? fnickname : nickname) + '回复了您的评论</p><p>' + content + '</p><p><a href="http://Cinoliu.leanapp.cn/post/?id=' + articleId + '">点击立即回复</a></p>';
    var user = 'zongyu.liu@foxmail.com'
    ...
    smtpTransport.sendMail({
        from    : 'Cinoliu Blog <zongyu.liu@foxmail.com>'
        , to      : toEmail
        , subject : title
        , html    : content
    }, function(err, res) {
